...
<?php
    ...
    include_once './admin_local_includes/contents/page_menu.php'; ?>
            ...
            <div class="ui mini breadcrumb">
                <a class="section" href="./index.php">Home</a><i class="right chevron icon divider"></i><a href="./banks.php" class="section">Back</a><i class="right chevron icon divider"></i><div class="active section"><?php echo PAGE_TITLE; ?></div>
            </div>
            <hr class="divider">
<?php include_once './admin_local_includes/contents/add_bank.inc.php'; ?>
