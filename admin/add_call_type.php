<?php 
    define('PAGE_TITLE', 'Add Call Type');
    define('HEADER', TRUE);
...
<div class="pusher">
    ...
    <div class="main-content">
        ...
        <div class="ui mini breadcrumb">
            <a class="section" href="./index.php">Home</a><i class="right chevron icon divider"></i><a href="./call_type.php" class="section">Back</a><i class="chevron icon divider"></i><div class="active section"><?php echo PAGE_TITLE; ?></div>
        </div>
        <hr class="divider">
        <?php include_once './admin_local_includes/contents/add_call_type.inc.php'; ?>
    </div>
    <!-- Main content starts here -->
</div>
<!-- Pusher ends here -->
