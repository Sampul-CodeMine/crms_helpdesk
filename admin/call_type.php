<?php 
    define('PAGE_TITLE', 'Call Type Management');
    define('HEADER', TRUE);
...
<div class="pusher">
    ...
    <div class="main-content">
        ...
        <div class="ui mini breadcrumb">
            <a class="section" href="./index.php">Home</a><i cass="right chevron icon divider"></i>
            <div class="active section"><?php echo PAGE_TITLE; ?></div>
        </div>
        <hr class="divider">
        <?php 
            include_once './admin_local_includes/contents/call_type.inc.php';
        ?>
    </div>
