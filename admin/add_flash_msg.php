<?php
    define('PAGE_TITLE', 'Add News Flash');
    define('HEADER', TRUE);
...
<?php
    ...
    include_once './admin_local_includes/contents/page_menu.php'; ?>
            ...
            <div class="ui mini breadcrumb">
                <a class="section" href="./index.php">Home</a><i class="right chevron icon divider"></i><a href="./flash_msg.php" class="section">Back</a><i class="right chevron icon divider"></i><div class="active section"><?php echo PAGE_TITLE; ?></div>
            </div>
            <hr class="divider">
<?php include_once './admin_local_includes/contents/add_flash_msg.inc.php'; ?>
